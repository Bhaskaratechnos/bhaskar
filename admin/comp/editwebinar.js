...
export default function Editwebinar(props) {
    ...
    const webinarupdate = async event => {
      ...
      const ress=await axios.put("https://api.phdcciwebinar.live/webinars/"+router.query.id, formData);
...
export async function getServerSideProps({query}) {
    ...
    const res = await fetch('https://api.phdcciwebinar.live/webinars/'+query.id)
