      ...
      <div className="main__container">
        ...
        <form onSubmit={webinarupdate}>
          ...
          <div className="form-group">
            ...
            <input type="date" className="form-control col-6" name="webinar_startdate" onChange={e => setwebinar_startdate(e.target.value)} />
            <input type="time" className="form-control col-6" name="webinar_starttime" onChange={e => setwebinar_starttime(e.target.value)} />
          ...
          <div className="form-group">
            ...
            <input type="date" className="form-control col-6" name="webinar_enddate" onChange={e => setwebinar_enddate(e.target.value)} />
            <input type="time" className="form-control col-6" name="webinar_endtime" onChange={e => setwebinar_endtime(e.target.value)} />
